...
Moreover, the aforementioned problems of usind ZW3 amplitude as a measure of QS3 activity puts into question the fundamental validity of the regression analysis using this variable. 


# Discussion

ZW amplitude is not a good measure for characterising QS behaviour for several reasons. By ignoring the phase component, it captures waves with one common wavenumber that nevertheless are very different and are exited by different procesess. This problem is exacerbated for periods or months that exibit low levels of steadiness. 