...
As an example of the former, @Quintanar1995a use the term “quasi-stationary waves (QS)” as defined by the zonally asymmetric componet of the climatological mean field. @Raphael2004 used the term "zonal wave (ZW)" when describing her index of planetary waves with wavenumber 3 that coincided in phase with the phase of the QS wave. @Irving2015 compare @Raphael2004's QS index with their own index computed as the integrated southern hemisphere zonal "waviness" irrespective of phase. 

As for intra-studies inconsistencies, @Rao2004 follow the nomenclature of @Quintanar1995a for QS, but they analize the mean amplitude of ZW instead of the amplitude of QS. @Kravchenko2012 analyze temperature ZW amplitude as a predictor of total ozone, but call it "quasi-stationary amplitude". @Turner2017 use the terms “planetary wave k”, “quasi-stationary wave k” and “wave number k” to describe analysis of QS associated with different wavenumbers k. Furthermore, @Lastovicka2018 study QS and ZW but they use the term “stationary planetary wave (SPW)” to refer to both.

The focus of this study is to stablish a clear distinction between ZW and QS and to show that the differences between the two convey meaningful information. We derive a measure of planetary wave stationarity from the ratio of QS to ZW amplitudes.

It is evident from the recent literature that both terms, QS and ZW, have been used interchangeably. However, there are not recent studies assessing how “stationary” or “quasi-stationary” the zonal waves are in the SH. The focus of this study is then to assess the...
