...
Local EOFs at 50 hPa seem to be well correlated along the whole hemisphere. The minimum correlation is between North America and European local EOFs, but even those are a very respectable 0.4. This suggests a more robust hemispheric mode that could easily earn the "Northern Annular Mode" designation. 
...
At 50 hPa, the correlations with the 1000 hPa regional indices are basically zonally symmetrical for the Atlantic and Eurasian regional EOFs, but much less so the the Pacific regional EOF, which has two negative correlations over the Pacific and over Europe and very weak positive correlations over the Arctic.
